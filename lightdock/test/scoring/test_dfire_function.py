...
class TestDFIRE:
    ...
    def test_calculate_DFIRE_1PPE(self, lig_file, rec_file):
    ...
    def test_calculate_DFIRE_1EAW(self, lig_file, rec_file):
        io = IOFactory(self.golden_data_path / rec_file).get_instance()
        atoms, _, chains = io.parse_complex_from_file(
            self.golden_data_path / rec_file
        )
    ...
    def test_calculate_DFIRE_1AY7(self, lig_file, rec_file):
        io = IOFactory(self.golden_data_path / rec_file).get_instance()
        atoms, _, chains = io.parse_complex_from_file(
            self.golden_data_path / rec_file
        )
