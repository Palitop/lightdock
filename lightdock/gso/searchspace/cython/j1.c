...
#define __pyx_n_u_j1 __pyx_string_tab[5]
#define __pyx_kp_u_j1_pyx __pyx_string_tab[6]
...
static const __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {__pyx_k_j1_pyx, sizeof(__pyx_k_j1_pyx), 0, 1, 0}, /* PyObject cname: __pyx_kp_u_j1_pyx */
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {2, 0, 0, 2, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 9, 147};
    PyObject* const varnames[] = {__pyx_mstate->__pyx_n_u_x, __pyx_mstate->__pyx_n_u_y};
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_j1_pyx, __pyx_mstate->__pyx_n_u_j1, __pyx_k_4s_1Bb_Rs_2Qar_AQb_1A_s_1D_Qb_2, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
